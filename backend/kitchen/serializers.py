...
class KitchenSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Kitchen
        fields = ["id", "name", "address", "contactNumber", "cuisine", "description", "logo", "banner", "openingHours", "orderAcceptTime", "owner"]
...
class MenuItemSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = MenuItem
        fields = ["id", "name", "description", "price", "image", "category", "isAvailable", "isVeg", "isSpicy", "kitchen"]
